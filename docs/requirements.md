...
| Accessibility   | WCAG 2.1 AA target: keyboard navigation, visible focus, ARIA labels on custom controls, confidence never conveyed by colour alone, minimum 4.5:1 contrast in both the light and the dark palette (asserted in tests, decisions D32 and D88). The palette follows the reader's system setting unless they say otherwise.                 |
